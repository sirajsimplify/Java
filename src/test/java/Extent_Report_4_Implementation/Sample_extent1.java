package Extent_Report_4_Implementation;
...
public class Sample_extent1 {
	 ...
	 extent.setSystemInfo("Name", "UniDev");
	 extent.setSystemInfo("Host Name", "Unified Development");
	         extent.setSystemInfo("Environment", "Testing");
	 extent.setSystemInfo("User Name", "Ravi and Navneet");
	 htmlReporter.config().setDocumentTitle("Execution report"); 
	                // Name of the report
	 htmlReporter.config().setReportName("Execution satus is displayed"); 
	                // Dark Theme
