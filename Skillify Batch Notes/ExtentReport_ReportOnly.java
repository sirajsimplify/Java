...
public class ExtentReport_ReportOnly {
	...
	{    
	    ...
	    ExtentHtmlReporter reporter=new ExtentHtmlReporter("ExtentReport/ExtentReport_ReportOnly.html");
	    ...
	    logger2.fail("Failed because of some issues", MediaEntityBuilder.createScreenCaptureFromPath("C:/Users/Ravi.V/Java_workspace/Sikuli_Proj_Muk_ExtentReport/Screenshots/logo/12.jpg").build());
        
	    logger2.pass("Failed because of some issues", MediaEntityBuilder.createScreenCaptureFromPath("C:/Users/Ravi.V/Java_workspace/Sikuli_Proj_Muk_ExtentReport/Screenshots/logo/11.jpg").build());
